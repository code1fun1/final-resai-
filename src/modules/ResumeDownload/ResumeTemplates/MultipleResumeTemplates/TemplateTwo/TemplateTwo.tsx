...
import { useStyles } from './TemplateTwoStyles';
      ...
      <Box className={styles.mainWrapper}>
          ...
          <Box className={`${styles.personalDetail} ${styles.displayColumn}`}>
            <Box>
              <Typography variant="h4">
                ...
                <span className={styles.headingColorChange}>
                  {lastName && isValidValue(lastName) && lastName}
                </span>
              </Typography>
              {/* <Typography variant="h4" className={styles.headingColorChange}>
                                {lastName && isValidValue(lastName) && lastName}
                            </Typography> */}
            </Box>
          </Box>
          ...
          {areAllFieldsFilled(education_details) && !degreeAllBlank && (
            <>
              <Box className={`${styles.educationDetail} ${styles.displayColumn}`}>
                {/* Education Start */}
                <Typography variant="h5" className={styles.headingColorChange}>
        ...
        <Box className={styles.rightSidebarDetail}>
          ...
          {areAllFieldsFilled(professional_development) && (
            <Box className={`${styles.educationDetail} ${styles.displayColumn}`} gap="15px">
              <Typography variant="h5" className={styles.headingColorChange}>
                    ...
                    (
                      ...
                      return (
                        <Box key={`${index}-${university}`} mb={1}>
                          {/* Show workshop and title in the first typography */}
                          {/* {(workshop || title) && (
                                                        <Typography variant="h5" style={{ textTransform: 'capitalize' }} className={styles.textCapitalise} textAlign="justify">
                                                            {`${title ? title : ''}${workshop && workshop !== title ? ', ' : ''}${workshop && workshop !== title && workshop}`}
                                                        </Typography>
                                                    )} */}

                          {/* Show university and date in the second typography */}
                          {/* {(university || date) && (
                                                        <Typography variant="h6" style={{ textTransform: 'capitalize' }} className={styles.textCapitalise} textAlign="justify">
                                                            {`${university ? university : ''}${date && (university) ? ', ' : ''}${date ? getYear(date) : ''}`}
                                                        </Typography>
                                                    )}
                          ...
                          {title && (
                            <Typography
                              variant="h6"
                              className={styles.textCapitalise}
                              textAlign="justify"
                            >
                              {' '}
                              {title}
          ...
          {areAllFieldsFilled(achievements_details) && (
            <Box className={styles.displayColumn} gap="1px">
              <Typography variant="h5" className={styles.headingColorChange}>
