...
const ApproachSection: FunctionComponent = () => {
  const comparisons: Comparison[] = [
    ...
    {
      id: 2,
      icon: "/images/img_pdf_note_black_900_01.svg",
      before: "Guessing what skills to add",
      after: "Clear skill gap report with specific skills to learn for your target role",
    },
    {
      id: 3,
  ...
  return (
    <section id="approach" className="w-full bg-[#f6f6f6] py-14 sm:py-16 lg:py-20">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-[100px]">
        ...
        <div className="flex flex-col gap-4 sm:gap-5">
          {comparisons.map((comparison) => (
            <div
              key={comparison.id}
              className="group relative w-full h-[80px] sm:h-[92px] lg:h-[106px] rounded-[18px] sm:rounded-[20px] lg:rounded-[24px] overflow-hidden"
            >
              {/* White card */}
